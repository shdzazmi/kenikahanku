...
!function (n) {
  ...
  var p,
    ...
    t,
    _w = function w(t, v) {
      if (_w.factory(t, v)) return _w;
      if (this instanceof _w) return P(t).DataTable(v);
      v = t, this.$ = function (t, e) {
        return this.api(!0).$(t, e);
      }, this._ = function (t, e) {
        return this.api(!0).rows(t, e).data();
      }, this.api = function (t) {
        return new _B(t ? ge(this[p.iApiIndex]) : this);
      ...
      var e,
        ...
        D = v === H,
        _ = this.length;
      for (e in D && (v = {}), this.oApi = this.internal = p.internal, _w.ext.internal) e && (this[e] = $e(e));
      return this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase()) W(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
          ...
          for (var n = _w.settings, o = 0, s = n.length; o < s; o++) {
            var a = n[o];
          ...
          null !== t && "" !== t || (t = "DataTables_Table_" + _w.ext._unique++, this.id = t);
          var f,
            d,
            h = P.extend(!0, {}, _w.models.oSettings, {
    ...
    _Y = function Y(t, e) {
      if (Array.isArray(e)) for (var n = 0; n < e.length; n++) _Y(t, e[n]);else t.push(e);
      return t;
    };
  function i(n) {
    var a,
  ...
  Array.isArray || (Array.isArray = function (t) {
  ...
  }), String.prototype.includes || (String.prototype.includes = s), _w.util = {
    ...
    set: function set(a) {
      var _d;
      return P.isPlainObject(a) ? _w.util.set(a._) : null === a ? function () {} : "function" == typeof a ? function (t, e, n) {
        a(t, "set", e, n);
        ...
        for (var a, r, o, i, l = dt(n), n = l[l.length - 1], s = 0, u = l.length - 1; s < u; s++) {
          ...
          if (a = l[s].match(ft), r = l[s].match(g), a) {
            if (l[s] = l[s].replace(ft, ""), t[l[s]] = [], (a = l.slice()).splice(0, s + 1), i = a.join("."), Array.isArray(e)) for (var c = 0, f = e.length; c < f; c++) _d(o = {}, e[c], i), t[l[s]].push(o);else t[l[s]] = e;
            return;
          }
      ...
      return P.isPlainObject(r) ? (o = {}, P.each(r, function (t, e) {
        ...
        if ("" !== n) for (var i = dt(n), l = 0, s = i.length; l < s; l++) {
          if (f = i[l].match(ft), a = i[l].match(g), f) {
            if (i[l] = i[l].replace(ft, ""), "" !== i[l] && (t = t[i[l]]), r = [], i.splice(0, l + 1), o = i.join("."), Array.isArray(t)) for (var u = 0, c = t.length; u < c; u++) r.push(_d2(t[u], e, o));
  ...
  function K(t) {
    ...
    if (e) for (var n = 0, a = e.length; n < a; n++) e[n] && C(_w.models.oSearch, e[n]);
  }
  function Q(t) {
  ...
  function tt(t) {
    var e, n, a, r;
    _w.__browser || (_w.__browser = e = {}, r = (a = (n = P("<div/>").css({
      position: "fixed",
      top: 0,
      ...
      width: "100%",
      height: 10
    }))).appendTo("body")).children()).children(), e.barWidth = a[0].offsetWidth - a[0].clientWidth, e.bScrollOversize = 100 === r[0].offsetWidth && 100 !== a[0].clientWidth, e.bScrollbarLeft = 1 !== Math.round(r.offset().left), e.bBounding = !!n[0].getBoundingClientRect().width, n.remove()), P.extend(t.oBrowser, _w.__browser), t.oScroll.iBarWidth = _w.__browser.barWidth;
  }
  ...
  function nt(t, e) {
    var n = _w.defaults.column,
      a = t.aoColumns.length,
      n = P.extend({}, _w.models.oColumn, n, {
    ...
    n[a] = P.extend({}, _w.models.oSearch, n[a]), at(t, a, P(e).data());
  }
  function at(t, e, n) {
    function a(t) {
    ...
    var e = t.aoColumns[e],
      r = t.oClasses,
      o = P(e.nTh),
      i = (!e.sWidthOrig && (e.sWidthOrig = o.attr("width") || null, u = (o.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/)) && (e.sWidthOrig = u[1]), n !== H && null !== n && (Q(n), C(_w.defaults.column, n, !0), n.mDataProp === H || n.mData || (n.mData = n.mDataProp), n.sType && (e._sManualType = n.sType), n.className && !n.sClass && (n.sClass = n.className), n.sClass && o.addClass(n.sClass), u = e.sClass, P.extend(e, n), F(e, n, "sWidth", "sWidthOrig"), u !== e.sClass && (e.sClass = u + " " + e.sClass), n.iDataSort !== H && (e.aDataSort = [n.iDataSort]), F(e, n, "aDataSort"), e.ariaTitle || (e.ariaTitle = o.attr("aria-label"))), e.mData),
      l = A(i),
  ...
  function lt(t) {
    for (var e, n, a, r, o, i, l, s = t.aoColumns, u = t.aoData, c = _w.ext.type.detect, f = 0, d = s.length; f < d; f++) if (l = [], !(o = s[f]).sType && o._sManualType) o.sType = o._sManualType;else if (!o.sType) {
  ...
  function x(t, e, n, a) {
    for (var r = t.aoData.length, o = P.extend(!0, {}, _w.models.oRow, {
        src: n ? "dom" : "data",
        idx: r
  ...
  function S(t, e, n, a) {
    ...
    return null === s && "display" === a ? "" : "filter" === a && (e = _w.ext.type.search)[o.sType] ? e[o.sType](s) : s;
  }
  function ct(t, e, n, a) {
    var r = t.aoColumns[n],
      o = t.aoData[e]._aData;
  ...
  function _t(t) {
    for (var e, n, a, r, o, i, l, s = t.oClasses, u = P(t.nTable), u = P("<div/>").insertBefore(u), c = t.oFeatures, f = P("<div/>", {
      ...
      if (e = null, "<" == (n = d[h])) {
        ...
        f.append(a), f = P(a);
      } else if (">" == n) f = f.parent();else if ("l" == n && c.bPaginate && c.bLengthChange) e = Gt(t);else if ("f" == n && c.bFilter) e = Lt(t);else if ("r" == n && c.bProcessing) e = Zt(t);else if ("t" == n) e = Kt(t);else if ("i" == n && c.bInfo) e = Ut(t);else if ("p" == n && c.bPaginate) e = zt(t);else if (0 !== _w.ext.feature.length) for (var p = _w.ext.feature, g = 0, b = p.length; g < b; g++) if (n == p[g].cFeature) {
        e = p[g].fnInit(t);
        break;
      }
  ...
  function Pt(t) {
    for (var e, n, a = _w.ext.search, r = t.aiDisplay, o = 0, i = a.length; o < i; o++) {
  ...
  function Ht(t, e, n, a, r, o) {
    var i,
      ...
      o = t.aiDisplayMaster,
      c = [];
    if (0 !== _w.ext.search.length && (n = !0), l = Wt(t), e.length <= 0) t.aiDisplay = o.slice();else {
  ...
  function I(t) {
    ...
    for (Array.isArray(f) && e(f), d && f.pre && e(f.pre), e(t.aaSorting), d && f.post && e(f.post), n = 0; n < h.length; n++) for (r = (o = c[s = h[n][a = 0]].aDataSort).length; a < r; a++) l = c[i = o[a]].sType || "string", h[n]._idx === H && (h[n]._idx = P.inArray(h[n][1], c[i].asSorting)), u.push({
      ...
      index: h[n]._idx,
      type: l,
      formatter: _w.ext.type.order[l + "-pre"]
    });
    return u;
  }
  function ie(t) {
  ...
  function fe(t, e) {
    for (var n, a, r, o = t.aoColumns[e], i = _w.ext.order[o.sSortDataType], l = (i && (n = i.call(t.oInstance, t, e, ot(t, e))), _w.ext.type.order[o.sType + "-pre"]), s = 0, u = t.aoData.length; s < u; s++) (a = t.aoData[s])._aSortData || (a._aSortData = []), a._aSortData[e] && !i || (r = i ? n[s] : S(t, s, e, "sort"), a._aSortData[e] = l ? l(r) : r);
  }
  function de(n) {
    var t;
    n._bLoadingState || (t = {
  ...
  function pe(n, t, e) {
    var a,
      r,
      o = n.aoColumns,
      i = (n._bLoadingState = !0, n._bInitComplete ? new _w.Api(n) : null);
    if (t && t.time) {
  ...
  function W(t, e, n, a) {
    if (n = "DataTables warning: " + (t ? "table id=" + t.sTableId + " - " : "") + n, a && (n += ". For more information about this error, please see https://datatables.net/tn/" + a), e) j.console && console.log && console.log(n);else {
      e = _w.ext, e = e.sErrMode || e.errMode;
  ...
  function De(r, o, t) {
    var e, n;
    t && (e = new _B(r)).one("draw", function () {
      t(e.ajax.json());
  ...
  function _e(t, e, n, a, r) {
    for (var o, i, l, s, u = [], c = _typeof(e), f = 0, d = (e = e && "string" != c && "function" != c && e.length !== H ? e : [e]).length; f < d; f++) for (l = 0, s = (i = e[f] && e[f].split && !e[f].match(/[\[\(:]/) ? e[f].split(",") : [e[f]]).length; l < s; l++) (o = n("string" == typeof i[l] ? i[l].trim() : i[l])) && o.length && (u = u.concat(o));
    var h = p.selector[t];
  ...
  var Ie = [],
    o = Array.prototype,
    _B = function B(t, e) {
      if (!(this instanceof _B)) return new _B(t, e);
      function n(t) {
        var e, n, a, r;
        t = t, a = _w.settings, r = P.map(a, function (t, e) {
          return t.nTable;
      ...
      this.context = z(o), e && P.merge(this, e), this.selector = {
        ...
        cols: null,
        opts: null
      }, _B.extend(this, this, Ie);
    },
    Fe = (_w.Api = _B, P.extend(_B.prototype, {
      any: function any() {
        return 0 !== this.count();
      },
      concat: o.concat,
      ...
      eq: function eq(t) {
        var e = this.context;
        return e.length > t ? new _B(e[t], this[t]) : null;
      },
      filter: function filter(t) {
        var e = [];
        if (o.filter) e = o.filter.call(this, t, this);else for (var n = 0, a = this.length; n < a; n++) t.call(this, this[n], n, this) && e.push(this[n]);
        return new _B(this.context, e);
      },
      flatten: function flatten() {
        var t = [];
        return new _B(this.context, t.concat.apply(t, this.toArray()));
      },
      join: o.join,
      ...
      iterator: function iterator(t, e, n, a) {
        ...
        return d.length || a ? ((t = (a = new _B(h, t ? d.concat.apply([], d) : d)).selector).rows = p.rows, t.cols = p.cols, t.opts = p.opts, a) : this;
      },
      ...
      slice: function slice() {
        return new _B(this.context, this);
      },
      sort: o.sort,
      splice: o.splice,
      ...
      unique: function unique() {
        return new _B(this.context, z(this));
      },
      unshift: o.unshift
    }), _B.extend = function (t, e, n) {
      if (n.length && e && (e instanceof _B || e.__dt_wrapper)) for (var a, r = 0, o = n.length; r < o; r++) e[(a = n[r]).name] = "function" === a.type ? function (e, n, a) {
        return function () {
          var t = n.apply(e, arguments);
          return _B.extend(t, t, a.methodExt), t;
        };
      }(t, a.val, a) : "object" === a.type ? {} : a.val, e[a.name].__dt_wrapper = !0, _B.extend(t, e[a.name], a.propExt);
    }, _B.register = e = function e(t, _e2) {
      if (Array.isArray(t)) for (var n = 0, a = t.length; n < a; n++) _B.register(t[n], _e2);else for (var r = t.split("."), o = Ie, i = 0, l = r.length; i < l; i++) {
        var s,
          u,
          c = function (t, e) {
    ...
    }, _B.registerPlural = t = function t(_t2, e, n) {
      _B.register(_t2, n), _B.register(e, function () {
        var t = n.apply(this, arguments);
        return t === this ? this : t instanceof _B ? t.length ? Array.isArray(t[0]) ? new _B(t.context, t[0]) : t[0] : H : t;
      });
    }, e("tables()", function (t) {
      return t !== H && null !== t ? new _B(ye(t, this.context)) : this;
    }), e("table()", function (t) {
      var t = this.tables(t),
        e = t.context;
      return e.length ? new _B(e[0]) : t;
    ...
    Ne = (e("columns()", function (n, a) {
      ...
      return P.isPlainObject(g) && (g.row === H ? (b = g, g = null) : (b = t, t = null)), P.isPlainObject(t) && (b = t, t = null), null === t || t === H ? this.iterator("table", function (t) {
        return a = t, t = g, e = we(b), f = a.aoData, d = Fe(a, e), n = _(m(f, d, "anCells")), h = P(_Y([], n)), p = a.aoColumns.length, _e("cell", t, function (t) {
          var e,
            n = "function" == typeof t;
          if (null === t || t === H || n) {
      ...
      "lib" === e || t.fn ? P = t : "win" == e || t.document ? v = (j = t).document : "datetime" !== e && "DateTime" !== t.type || (_w.DateTime = t);
    }, _w.factory = function (t, e) {
      var n = !1;
      return t && t.document && (v = (j = t).document), e && e.fn && e.fn.jquery && (P = e, n = !0), n;
    }, _w.versionCheck = _w.fnVersionCheck = function (t) {
      for (var e, n, a = _w.version.split("."), r = t.split("."), o = 0, i = r.length; o < i; o++) if ((e = parseInt(a[o], 10) || 0) !== (n = parseInt(r[o], 10) || 0)) return n < e;
      return !0;
    }, _w.isDataTable = _w.fnIsDataTable = function (t) {
      var r = P(t).get(0),
        o = !1;
      return t instanceof _w.Api || (P.each(_w.settings, function (t, e) {
        var n = e.nScrollHead ? P("table", e.nScrollHead)[0] : null,
          a = e.nScrollFoot ? P("table", e.nScrollFoot)[0] : null;
        e.nTable !== r && n !== r && a !== r || (o = !0);
      }), o);
    }, _w.tables = _w.fnTables = function (e) {
      var t = !1,
        n = (P.isPlainObject(e) && (t = e.api, e = e.visible), P.map(_w.settings, function (t) {
          if (!e || P(t.nTable).is(":visible")) return t.nTable;
        }));
      return t ? new _B(n) : n;
    }, _w.camelToHungarian = C, e("$()", function (t, e) {
      ...
      return new _B(this.context, this.context);
    }), e("init()", function () {
      var t = this.context;
      ...
      return c = c || !1, this.iterator("table", function (e) {
        var n,
          ...
          }), P.inArray(e, _w.settings));
        -1 !== u && _w.settings.splice(u, 1);
      });
    ...
    }), _w.version = "1.13.11", _w.settings = [], _w.models = {}, _w.models.oSearch = {
      bCaseInsensitive: !0,
      sSearch: "",
      bRegex: !1,
      bSmart: !0,
      ...
      oSearch: P.extend({}, _w.models.oSearch),
      sAjaxDataProp: "data",
      sAjaxSource: null,
      sDom: "lfrtip",
      searchDelay: null,
      ...
      renderer: null,
      rowId: "DT_RowId"
    }, i(_w.defaults), _w.defaults.column = {
      aDataSort: null,
      iDataSort: -1,
      asSorting: ["asc", "desc"],
      bSearchable: !0,
      ...
      sType: null,
      sWidth: null
    }, i(_w.defaults.column), _w.models.oSettings = {
      oFeatures: {
        bAutoWidth: null,
        bDeferRender: null,
        bFilter: null,
      ...
      _unique: 0,
      fnVersionCheck: _w.fnVersionCheck,
      iApiIndex: 0,
      oJUIClasses: {},
      sVersion: _w.version
    }, P.extend(p, {
  ...
  P.extend(Ne, {
    ...
    _numbers: Oe,
    numbers_length: 7
  }), P.extend(!0, _w.ext.renderer, {
    pageButton: {
      _: function _(u, t, c, e, f, d) {
        function h(t, e) {
          for (var n, a = b.sPageButtonDisabled, r = function r(t) {
  ...
  }), P.extend(_w.ext.type.detect, [function (t, e) {
  ...
  function ke(t, e, n, a) {
    var r;
    return 0 === t || t && "-" !== t ? "number" == (r = _typeof(t)) || "bigint" == r ? t : +(t = (t = e ? $(t, e) : t).replace && (n && (t = t.replace(n, "")), a) ? t.replace(a, "") : t) : -1 / 0;
  }
  function Me(n) {
    P.each({
      num: function num(t) {
  ...
  function Ve(s) {
    return function (a, r, o, i) {
      ...
      var l = "datetime-" + r;
      return _w.ext.type.order[l] || (_w.ext.type.detect.unshift(function (t) {
        return t === l && l;
      }), _w.ext.type.order[l + "-asc"] = function (t, e) {
        t = t.valueOf(), e = e.valueOf();
        return t === e ? 0 : t < e ? -1 : 1;
      }, _w.ext.type.order[l + "-desc"] = function (t, e) {
        t = t.valueOf(), e = e.valueOf();
  ...
  function $e(e) {
    return function () {
      var t = [ge(this[_w.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
      return _w.ext.internal[e].apply(this, t);
    };
  }
  return _w.datetime = function (n, a) {
    var r = "datetime-detect-" + n;
    a = a || "en", _w.ext.type.order[r] || (_w.ext.type.detect.unshift(function (t) {
      var e = Ue(t, n, a);
      return !("" !== t && !e) && r;
    }), _w.ext.type.order[r + "-pre"] = function (t) {
      return Ue(t, n, a) || 0;
    });
  }, _w.render = {
  ...
  }), ((P.fn.dataTable = _w).$ = P).fn.dataTableSettings = _w.settings, P.fn.dataTableExt = _w.ext, P.fn.DataTable = function (t) {
    return P(this).dataTable(t).api();
  }, P.each(_w, function (t, e) {
    P.fn.DataTable[t] = e;
  }), _w;
});
